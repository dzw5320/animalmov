...
L1=np.array([200, 350, 500])
L2=np.array([200, 350, 500])
L3=np.array([0, 200, 300])
...
for r in range(0,324,1):
    ...
    x=Dense(L1, activation='relu')(main_input)
    ...
    tune[r, 6]=np.mean(scorestrain[74:147])
    ...
    tune[r, 7]=np.mean(scorestest[74:147])
    np.save('NNcolmovtune.npy', tune)
