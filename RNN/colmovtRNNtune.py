...
import keras
from keras.layers import Input, Embedding, Dense, Dropout, LSTM, SimpleRNN
...
for r in range(0, 145, 1):
  ...
  x=SimpleRNN(350, activation='tanh',dropout=tune[r,0], recurrent_dropout=tune[r, 1], return_sequences=True)(main_input)
  ...
  np.save('RNNcolmovtune.npy', tune)