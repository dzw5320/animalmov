...
for r in range(0,144,1):
  ...
  x=SimpleRNN(75, activation='tanh',recurrent_dropout=tune[r,1], dropout=tune[r,0], return_sequences=True )(main_input, training=True)
  ...
  np.save('RNNindveltune.npy', tune)